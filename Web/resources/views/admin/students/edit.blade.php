...
<div class="container-fluid py-4">
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            <h2 class="fw-bold text-white mb-0">Update Student Profile</h2>
            <p class="text-white-50 small mb-0">Modify academic information or update credentials for <strong>{{ $student->name }}</strong>.</p>
        </div>
    ...
    @if ($errors->any())
        <div class="alert alert-danger border-0 bg-danger bg-opacity-10 text-danger mb-4 shadow-sm" role="alert">
            <div class="d-flex align-items-center mb-2">
                ...
                <h6 class="mb-0 fw-bold">Update Failed</h6>
            </div>
            <ul class="mb-0 small">
    ...
    <form action="{{ route('admin.students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="card glass border-0 shadow-lg mb-4">
                    <div class="card-header bg-white bg-opacity-5 border-0 py-3">
                        <h6 class="mb-0 text-white fw-bold"><i class="bi bi-shield-lock me-2 text-amber"></i>Account Security</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="email" class="form-label text-white-50 small fw-semibold">Email Anchor</label>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label text-white-50 small fw-semibold">Reset Password <span class="text-white-25 fw-normal">(Leave blank if unchanged)</span></label>
                                <div class="input-group">
                ...
                <div class="card glass border-0 shadow-lg mb-4">
                    <div class="card-header bg-white bg-opacity-5 border-0 py-3">
                        <h6 class="mb-0 text-white fw-bold"><i class="bi bi-mortarboard me-2 text-amber"></i>Academic Records</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="nisn" class="form-label text-white-50 small fw-semibold">NISN</label>
                                <input type="text" class="form-control" id="nisn" name="nisn" value="{{ old('nisn', $student->student->nisn ?? '') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="nis" class="form-label text-white-50 small fw-semibold">Internal ID (NIS)</label>
                                <input type="text" class="form-control" id="nis" name="nis" value="{{ old('nis', $student->student->nis ?? '') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="grade" class="form-label text-white-50 small fw-semibold">Grade Assignment</label>
                            ...
                            <div class="col-md-6">
                                <label for="phone_number" class="form-label text-white-50 small fw-semibold">Phone Relay</label>
                                <div class="input-group">
            ...
            <div class="col-lg-4">
                ...
                <div class="card glass border-0 shadow-lg mb-4">
                    <div class="card-header bg-white bg-opacity-5 border-0 py-3">
                        <h6 class="mb-0 text-white fw-bold"><i class="bi bi-camera me-2 text-amber"></i>Presence Identity</h6>
                    </div>
                    <div class="card-body p-4 text-center">
                        <div class="mb-4">
                            ...
                            @endif
                            <p class="text-white-25 small mb-0">Current identification photo</p>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="form-text text-white-25 small text-start mt-2">Leave blank to retain current photo. Max 2MB.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card glass border-0 shadow-lg position-sticky" style="top: 2rem;">
                    <div class="card-body p-4">
                        <button type="submit" class="btn btn-warning w-100 py-3 fw-bold shadow-lg border-0 mb-3 text-dark">
                            <i class="bi bi-arrow-repeat me-2"></i>Synchronize Profile
                        </button>
                        <p class="text-white-50 small text-center mb-0 px-2">
                            Validated updates will propagate across all terminal nodes immediately.
                        </p>
                    </div>
                </div>
            </div>
